...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["rubric_template_id"], ["rubric_templates.id"], name="fk_criterion_rubric"
        ),
    )
    op.create_index(
        "ix_rubric_criteria_rubric_template_id", "rubric_criteria", ["rubric_template_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["application_id"], ["candidate_applications.id"], name="fk_interview_application"
        ),
        sa.ForeignKeyConstraint(["interviewer_id"], ["users.id"], name="fk_interview_interviewer"),
        sa.ForeignKeyConstraint(
            ["rubric_template_id"], ["rubric_templates.id"], name="fk_interview_rubric"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["submitted_by_id"], ["users.id"], name="fk_scorecard_submitted_by"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["criterion_id"], ["rubric_criteria.id"], name="fk_score_criterion"
        ),
    )
